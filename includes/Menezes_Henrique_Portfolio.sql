...
--
-- Host: localhost:8889
-- Tempo de geração: 09/12/2024 às 04:46
...
(34, 'a', 'asd@gmail.com', '', ''),
(35, 'HENRIQUE GAMBORGI MENEZES', 'henrique.g.m@hotmail.com', '', '');
...
(45, 'boqueirao-1.png', 'Boqueirão Banner', 7),
(46, 'boqueirao-2.png', 'Boqueirão Logo Versions', 7),
(47, 'boqueirao-3.png', 'Boqueirão Concepts', 7),
(48, 'boqueirao-4.webp', 'Boqueirão Social Media', 7),
(49, 'boqueirao-5.webp', 'Boqueirão Logo Closeups', 7),
(50, 'boqueirao-6.webp', 'Boqueirão Applications', 7),
(51, 'boqueirao-7.png', 'Boqueirão Uniforms', 7),
(52, 'boqueirao-8.webp', 'Boqueirão Calendar', 7),
(53, 'boqueirao-9.png', 'Boqueirão Grid', 7),
(54, 'elin-1.jpg', 'Elin Logo', 8),
(55, 'elin-2.jpg', 'Elin Magazine', 8),
(56, 'elin-3.jpg', 'Elin Social Media', 8),
(57, 'elin-4.jpg', 'Elin Social Ad', 8),
(58, 'elin-5.jpg', 'Elin Product Line', 8),
(59, 'elin-6.jpg', 'Elin Eco Bag', 8),
(60, 'elin-7.jpg', 'Elin Shop', 8);
...
(7, 'Boqueirão', 'Farm Hotel', 'cover_boqueirao.webp', 'thumb_boqueirao.webp', 'https://boqueiraohotelfazenda.com.br/', 'real', 'Jan, 2022', 'This is a current client — Jan, 2022 to present', 'Marketing Manager, Lead Brand and UX Designer', 'Branding, Marketing, Web and UX Design', 'Boqueirão is a farm hotel with more than 30 years of memories in Santa Catarina\'s mountain range. This project consisted in redesigning the hotel\'s brand, website and overall client experience during their stay. After success in implementation, the project was extended to handle digital marketing and overall design needs. Today, we have completely revolutionized Boqueirão\'s experience, increasing brand recognition and digital connections. This is a real project for an amazing business, you should come and visit!', 'Boqueirão Farm Hotel is a beloved destination in the mountain range o Lages (Santa Catarina, Brasil), known for its rich tradition, comfort and memorable moments, boasting over 30 years of business. This project began in 2022 with the goal of revitalizing the hotel’s brand identity, website, and the overall guest experience to reflect modern expectations while preserving its unique heritage. The scope expanded beyond the initial redesign to include comprehensive digital marketing strategies and ongoing design support. This endeavor has successfully transformed Boqueirão\'s digital presence, creating a more cohesive brand and connecting with a broader audience. Through strategic updates and digital approaches, the project has enhanced customer engagement and solidified Boqueirão’s reputation as a top-tier lodging option.', 'I worked in this project with different people in different sectors of the Hotel, specially commercial, strategy and external relations. Not only to make sure the website would work, capturing dozens of reservations weekly and connecting with the overall guest experience, but to market digital campaigns and capture new audiences, with new contents and materials. This was definitely a full-time experience, as I ended up founding the Marketing sector in the Hotel and dealign with all-purposes materials, including: WordPress maintenance, Meta and Google Ads, video production for TV, content creation, social media management, and design for printing, editorials, merchandising, way finding and internal communication.', 'This was definitely one of the most hardworking and satisfying projects I have ever worked with. Not only it required so much of me, with different strategies to communicate so many facets of the business, but to create new materials to keep adapting to a modern demand. This experience not only enhanced my proficiency in integrating design with strategic marketing but also strengthened my collaborative abilities when working with different people and areas to achieve results. After the launching of the new website, we have experienced an increase of visits, conversions and time spent in our webpage. After 12 months working together in different approaches and marketing strategies, the Hotel hit the best months in its history, followed by one of the best years. We’re still working together, improving and growing those numbers!', 'Adobe Illustrator, Adobe Photoshop, Adobe Premiere, Figma and Trello for team workflow interaction. Facebook, Instagram, Google and YouTube Ads for social media marketing. Wordpress, Google Tag Manager and Analytics for website management and improvement.'),
(8, 'Elin', 'Cosmetics', 'cover_elin.webp', 'thumb_elin.webp', 'https://behance.com/ickgamborgi', 'academic', 'Nov, 2024', '3 months — September to November 2024', 'Full stack and Sole Designer', 'Branding and Product Design', 'Elin Cosmetics is a fantasy brand created for purpose studies. Rooted in nature and personal wellbeing, with a mission to transform everyday moments into opportunities for self-care. Developed for the Interactive Media Design Program during my Fanshawe graduation.', 'Elin Cosmetics was conceptualized as a fantasy brand for study purposes. The brand’s identity is rooted in wellbeing, quality and elegance. The project’s goal was to create a cohesive brand identity that reflects these values while showcasing a luxurious and empowering visual presence. Alongside, creating also the product line and proper packaging for each product.', 'The creation began with a research of market, followed by a definition and exploration of its core values: Nature, Wellbeing, Exotic, Quality, and Elegance.\r\nThe design process focused on building a consistent visual identity, from logo creation to branding applications. The use of natural imagery and a harmonious color palette reinforced the brand’s dedication to authenticity. Special attention was given to crafting an elegant user experience, ensuring that every package piece communicated Elin’s promise of quality and refinement.', 'The project allowed me to deepen my skills in brand design and storytelling. I learned the importance of aligning visual elements with core brand values, working with packaging and creating a compelling narrative to engage the target audience.', 'Adobe Illustrator, Adobe Photoshop, Adobe InDesign and Cinema 4D.');
