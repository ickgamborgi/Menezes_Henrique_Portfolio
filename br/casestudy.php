...
<head>
    ...
    <meta property="og:title" content="Estudo: <?php echo $row['title']?> <?php echo $row['subtitle']?>">
    ...
    <meta name="twitter:title" content="Estudo: <?php echo $row['title']?> <?php echo $row['subtitle']?>">
    ...
    <!-- Document Title -->
    <title>Estudo: <?php echo $row['title']?> <?php echo $row['subtitle']?></title> 
</head>

<!-- Documemnt Body -->
<body>
    <h1 class="hidden">Estudo: <?php echo $row['title']?> <?php echo $row['subtitle']?></h1>
    ...
    <main>
                ...
                <div class="col-span-full banner-title">
                    ...
                    <div class="col-span-full case-wrap">
                        <a href="<?php echo $row['prototype_link']?>" target="_blank" class="banner-btn">
                            <h4 class="small-button">Abrir Criação</h4>
                        </a>
                        <div class="case-type">
                            <i class="fa-solid fa-earth-americas icon"></i>
                            <h4>Projeto <?php echo $row['type']?></h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bio grid-con bio">
            ...
            <div class="project-thank col-span-full">
                ...
                <div class=back-wrap>
                    <h4>Obrigado por ler!</h4>
                    <a href="index.php#portfolio-sec" class="back-btn col-span-3">
                            <h5 class="small-button">Voltar ao Portfólio</h5>
                    </a>
                </div>
            </div>
