...
<body>
    <h1 class="hidden">Painel de Controle</h1>
    ...
    <main>
        ...
        <section class="grid-con edit-project-section">
            <div class="col-span-full admin-welcome">
                <h3><i class="fas fa-gear icon-gear"></i> Olá, <?php echo htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8'); ?></h3>
                <p>Bem-vindo à minha Central de Controle de Conteúdo. Aqui você pode <span>CRIAR, LER, ATUALIZAR</span> e <span>DELETAR</span> qualquer conteúdo do meu site.</p><br>
                <p>Use os botões abaixo para navegar mas,<span> cuidado! Todas as alterações são definitivas!</span></p>
            </div>
