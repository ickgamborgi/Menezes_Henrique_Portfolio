...
<head>
    ...
    <!-- Document Title -->
    <title>Gerenciar Recomendações</title> 
</head>

<body>
    <h1 class="hidden">Gerenciar Recomendações</h1>
    ...
    <main>
        ...
        <div class="col-span-full admin-welcome">
                <h3><i class="fas fa-solid fa-users"></i>Gerenciar Recomendações</h3>
                <p>Aqui você pode <span>CRIAR, LER, ATUALIZAR</span> e <span>DELETAR</span> recomendações do website.</p>
        </div>
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<div class="project-list-crud-item">
                            ...
                            <div class="crud-item-action">
                                <a class="edit-button" href="edit_testimonial_form.php?id='.$row['id'].'">editar</a>
                                <a class="delete-button" href="delete_testimonial.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this testimonial?\');">deletar</a>
                            </div>
                            </div>';
                    }
        ...
        <section class="grid-con project-add-crud">
            <div class="project-add-crud-con col-span-full">
                <h3><i class="fas fa-plus icon-add"></i> Adicionar Nova Recomendação</h3>
                <form action="add_testimonial.php" method="post" enctype="multipart/form-data" class="form">
                    ...
                    <label class="form-label" for="position">Posição: </label>
                    ...
                    <label class="form-label" for="quote">Recomendação: </label>
                    ...
                    <input id="submit-button" name="submit" type="submit" value="Adicionar Recomendação">
                </form>
            </div>
        </section>
