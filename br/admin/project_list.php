...
<body>
    <h1 class="hidden">Lista de Projetos</h1>
    ...
    <main>
        ...
        <div class="col-span-full admin-welcome">
                <h3><i class="fas fa-solid fa-object-group"></i>Gerenciar Projetos</h3>
                <p>Aqui você pode <span>CRIAR, LER, ATUALIZAR</span> e <span>DELETAR</span> projetos do meu website.</p>
        </div>

            <div class="project-list-crud col-span-full">
               <h3 class="col-span-full"><i class="fas fa-list icon-list"></i>Todos os Projetos</h3>
                    <?php
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<div class="project-list-crud-item">
                            ...
                            <div class="crud-item-action">
                                <a class="edit-button" href="edit_project_form.php?id='.$row['id'].'">editar</a>
                                <a class="delete-button" href="delete_project.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure you want to delete this project?\');">deletar</a>
                            </div>
                            </div>';
                    }
        ...
        <section class="grid-con project-add-crud">
            ...
            <h3><i class="fas fa-plus icon-add"></i>Adicionar Novo Projeto</h3>
                <form action="add_project.php" method="post" enctype="multipart/form-data" class="form">
                    ...
                    <label class="form-label" for="prototype_link">Link do Protótipo: </label>
                    ...
                    <label class="form-label" for="recap">Introdução do Projeto: </label>
                    ...
                    <label class="form-label" for="takeaways">Resultados do Projeto: </label>
                    ...
                    <label class="form-label" for="media">Adicionar Mídia: </label>
                    ...
                    <input id="submit-button" name="submit" type="submit" value="Adicionar Projeto">
                </form>
        </section>
