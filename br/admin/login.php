...
<body>
    <h1 class="hidden">Login de Administrador</h1>
       ...
       <section class="admin-section grid-con">
            <div class="login-form col-span-full">
                ...
                <form action="log.php" method="post" id="login-form">
                    ...
                    <div id="feedback" class="hidden col-span-full"><p>Por favor, preencha todos os campos.</p></div>
                    <input type="submit" value="Access" id="submit-button">
                </form>
                
                <p class="form-restriction-text">Esta á uma área restrita do meu website. Se precisar de ajuda, entre em contato em <a href="../contact.php" target="_blank">Página de Contato.</a></p>
            </div>

            <div class="logout-button col-span-full">
                    <a href="../index.php"><h5>Mudar para Página de Usuário</h5></a>
                </div>
        </section>
