...
<head>
    ...
    <!-- Document Title -->
    <title>Editar Rceomendação</title> 
</head>

<body>
    <h1 class="hidden">Editar Recomendação</h1>
    ...
    <main>
        ...
        <section class="grid-con edit-project-section">
            <a href="testimonial_list.php" class="col-span-full cms-back-button"><h3>< Voltar para Recomendações</h3></a>
            <div class="edit-project-con col-span-full">
                <h4 class="col-span-full"><i class="fas fa-edit icon-edit"></i>Editar Recomendação</h4>
